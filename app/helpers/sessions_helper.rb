module SessionsHelper
	...
	def sign_in(student)
		...
		student.update_attribute(:remember_token, Student.encrypt(remember_token)) #save encrypted cookie to the db
 	...
 	def sign_out
 		current_student.update_attribute(:remember_token, Student.encrypt(Student.new_remember_token))
