...
class RecruitersControllerTest < ActionController::TestCase
  ...
  test "should create recruiter" do
    assert_difference('Recruiter.count') do
      post :create, recruiter: { city: @recruiter.city, company: @recruiter.company, country: @recruiter.country, email: @recruiter.email, name: @recruiter.name }
    end
  ...
  test "should update recruiter" do
    patch :update, id: @recruiter, recruiter: { city: @recruiter.city, company: @recruiter.company, country: @recruiter.country, email: @recruiter.email, name: @recruiter.name }
    assert_redirected_to recruiter_path(assigns(:recruiter))
  end
